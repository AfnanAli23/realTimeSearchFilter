...
function displayUser(usersArray) {
	...
	usersArray.forEach((e) => {
		...
		blurredLayer.style.backgroundImage = `url(${e.pic})`;
...
// 	let newUser = users.filter((searchedUser) => {
// 		return searchedUser.name.toLowerCase().startsWith(inp.value.toLowerCase());
// 	});
// 	displayUser(newUser);
// });
